import { ChainId, WETH, Token, Fetcher, SmartRouter } from '../src'
...
describe.skip('data', () => {
  ...
  it('Pair', async () => {
    const token = new Token(ChainId.MAINNET, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18) // DAI
    const pair = await Fetcher.fetchPairData(WETH[ChainId.MAINNET], token, SmartRouter.APE)
